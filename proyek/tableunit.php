    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="container mt-4 ">
          <h1 class="text-center mb-3">Unit Kontainer</h1>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="d-flex gap-1 ">
                        <div class="mx-4">
                          <button type="button" class="btn btn-info btn-sm">Jual </button>
                    ...
                    <tr>
                      ...
                      <td>Red</td>
                      <td>$45,000</td>
                      <td class="d-flex d-sm-block gap-2 justify-content-center">
                        <div class="mx-4">
                          <button type="button" class="btn btn-info btn-sm ">Jual </button>
                          <button type="button" class="btn btn-warning btn-sm">Edit</button>
                        </div>
                    ...
                    <tr>
                      ...
                      <td>Red</td>
                      <td>$45,000</td>
                      <td class="flex-wrap d-sm-block gap-2 justify-content-center">
                        <div class="mx-4">
                          <button type="button" class="btn btn-info btn-sm ">Jual </button>
                          <button type="button" class="btn btn-warning btn-sm">Edit</button>
                        </div>
