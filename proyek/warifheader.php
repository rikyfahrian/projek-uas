...
<head>
  ...
  <!--mengambil style khusus untuk side dan navbar-->
...
<body class="bg-dark-subtle">
  <!--link untuk aset icon dan lainya-->
  ...
  <header class="navbar border-bottom  border-dark-subtle sticky-top bg-dark-subtle flex-md-nowrap p-0 shadow">
    ...
    <?php
      ...
      ?>
          ...
          <p class="block text-gray-700 text-sm font-bold mb-2 mx-2"> Rp. <?php echo number_format( $row["nominal"], 0, ',', '.'); ?></p>
          </div>
        <?php
        ...
        <div class="d-flex justify-content-end mx-3">
          ...
          <h5 class="block text-gray-700 text-sm font-bold mb-2 mx-2"> Rp. 0</h5>
        </div>
      <?php
      }
      ?>
        ...
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2 active" aria-current="page" href="/projek-uas/proyek/landingpage.php">
                  <svg class="bi">
              ...
              <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="tambah_unit.php">
                  <svg class="bi">
                    <use xlink:href="#cart" />
                  </svg>
                  Tambah Unit
