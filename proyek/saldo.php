...
<html lang="en" data-bs-theme="auto">
  ...
  <body class="bg-dark-subtle">
    ...
    <div class="container-fluid">
      <div class="row">
        <div
          class="sidebar border-end border-dark-subtle border-2 col-md-3 col-lg-2 p-0 bg-body-tertiary"
        >
          <div
       ...
       <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          ...
          <!--saldo form-->
    <div class="row">
    <div class="container mt-4 col-md-11 mb-4">
      <div class="card mb-4">
        ...
        <div class="card-body mt-4">
          <form>
            ...
            <div class="row mb-4">
              <div class="col">
                <div class="form-outline">
                  <input type="text" id="rekening" class="form-control" />
